...
echo "de8d90e380232755abc4f74b639c4c66  $ST/sfp_cockpit_view.py"     | md5sum -c -
...
echo "de8d90e380232755abc4f74b639c4c66  $ROOT/trading_corp/web/sfp_cockpit_view.py"                   | md5sum -c -
