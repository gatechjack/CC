...
$sh = Join-Path $PSScriptRoot "pm_cs2_legaudit_diag_ro.sh"
...
$res | Out-File -FilePath "$out\pm_cs2_legaudit_diag.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- pm_cs2_legaudit_diag_ro exit ($LASTEXITCODE) ----"
