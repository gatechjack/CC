...
$sh = Join-Path $PSScriptRoot "legpm_p2_timers_stop.sh"
...
$res | Out-File -FilePath "$out\legpm_p2_timers_stop.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p2_timers_stop exit ($LASTEXITCODE) ----"
