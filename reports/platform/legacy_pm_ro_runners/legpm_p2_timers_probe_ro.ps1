...
$sh = Join-Path $PSScriptRoot "legpm_p2_timers_probe_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p2_timers_probe.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p2_timers_probe_ro exit ($LASTEXITCODE) ----"
