...
$sh = Join-Path $PSScriptRoot "legpm_p3_apify_cease_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p3_apify_cease.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p3_apify_cease_ro exit ($LASTEXITCODE) ----"
