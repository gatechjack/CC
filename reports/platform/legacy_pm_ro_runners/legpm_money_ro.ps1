...
$sh = Join-Path $PSScriptRoot "legpm_money_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_money.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_money_ro exit ($LASTEXITCODE) ----"
