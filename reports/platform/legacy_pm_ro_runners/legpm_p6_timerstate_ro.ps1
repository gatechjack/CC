...
$sh = Join-Path $PSScriptRoot "legpm_p6_timerstate_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p6_timerstate.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p6_timerstate_ro exit ($LASTEXITCODE) ----"
