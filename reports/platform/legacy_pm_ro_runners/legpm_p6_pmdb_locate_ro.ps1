...
$sh = Join-Path $PSScriptRoot "legpm_p6_pmdb_locate_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p6_pmdb_locate.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p6_pmdb_locate_ro exit ($LASTEXITCODE) ----"
