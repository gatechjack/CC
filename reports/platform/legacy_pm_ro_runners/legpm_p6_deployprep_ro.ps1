...
$sh = Join-Path $PSScriptRoot "legpm_p6_deployprep_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p6_deployprep.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p6_deployprep_ro exit ($LASTEXITCODE) ----"
