...
$sh = Join-Path $PSScriptRoot "legpm_p7_dbstats_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p7_dbstats.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p7_dbstats_ro exit ($LASTEXITCODE) ----"
