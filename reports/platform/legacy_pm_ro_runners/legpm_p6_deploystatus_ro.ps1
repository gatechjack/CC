...
$sh = Join-Path $PSScriptRoot "legpm_p6_deploystatus_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p6_deploystatus.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p6_deploystatus_ro exit ($LASTEXITCODE) ----"
