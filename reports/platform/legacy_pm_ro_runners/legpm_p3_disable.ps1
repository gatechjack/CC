...
$sh = Join-Path $PSScriptRoot "legpm_p3_disable.sh"
...
$res | Out-File -FilePath "$out\legpm_p3_disable.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p3_disable exit ($LASTEXITCODE) ----"
