...
$sh = Join-Path $PSScriptRoot "legpm_p2_disable.sh"
...
$res | Out-File -FilePath "$out\legpm_p2_disable.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p2_disable exit ($LASTEXITCODE) ----"
