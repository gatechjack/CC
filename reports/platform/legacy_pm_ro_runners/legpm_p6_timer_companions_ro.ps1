...
$sh = Join-Path $PSScriptRoot "legpm_p6_timer_companions_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p6_timer_companions.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p6_timer_companions_ro exit ($LASTEXITCODE) ----"
