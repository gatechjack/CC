...
$sh = Join-Path $PSScriptRoot "legpm_p5_kcv2_prep_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p5_kcv2_prep.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p5_kcv2_prep_ro exit ($LASTEXITCODE) ----"
