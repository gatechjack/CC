...
$sh = Join-Path $PSScriptRoot "legpm_p6_gate_watch_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p6_gate_watch.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p6_gate_watch_ro exit ($LASTEXITCODE) ----"
