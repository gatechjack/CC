...
$sh = Join-Path $PSScriptRoot "legpm_p6_baseline_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p6_baseline.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p6_baseline_ro exit ($LASTEXITCODE) ----"
