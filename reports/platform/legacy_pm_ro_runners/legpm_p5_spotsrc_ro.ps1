...
$sh = Join-Path $PSScriptRoot "legpm_p5_spotsrc_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p5_spotsrc.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p5_spotsrc_ro exit ($LASTEXITCODE) ----"
