...
$sh = Join-Path $PSScriptRoot "legpm_wiring_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_wiring.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_wiring_ro exit ($LASTEXITCODE) ----"
