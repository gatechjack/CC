...
$sh = Join-Path $PSScriptRoot "legpm_p3_investigate_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_p3_investigate.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_p3_investigate_ro exit ($LASTEXITCODE) ----"
