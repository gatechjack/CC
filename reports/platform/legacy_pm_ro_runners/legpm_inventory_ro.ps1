...
$sh = Join-Path $PSScriptRoot "legpm_inventory_ro.sh"
...
$res | Out-File -FilePath "$out\legpm_inventory.txt" -Encoding utf8; $res | Write-Host
Write-Host "---- legpm_inventory_ro exit ($LASTEXITCODE) ----"
