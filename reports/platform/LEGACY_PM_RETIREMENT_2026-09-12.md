...
- **STATUS: Steps A/B/2 DONE + all runners built/validated/scratch-proven. Awaiting Jack's go for the backup->DROP window.** No restart, no code removal, no API cancels this phase.
