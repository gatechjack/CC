...
- **STATUS: items 1+2 BUILT + PROVEN LOCAL (5-template cluster + 2 imports); item 3 = plan + survey runner (box-gated, unrun); item 4 = CLOSED (leave it). RULING 1+2 recorded; §16.7 exact commands recorded. NOTHING deployed / pushed / restarted / reached the box.**
