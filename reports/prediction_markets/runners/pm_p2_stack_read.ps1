...
# READ-ONLY. Root-reads Caddy + Authelia config (secrets redacted) via az run-command. No edits, no reload.
$sh = "C:\Users\AA Incorporado\cc\_p2_stack_read.sh"
...
Write-Host "[remote] READ-ONLY Caddy+Authelia dump (root via az; secrets redacted; no edits, no reload)..."
