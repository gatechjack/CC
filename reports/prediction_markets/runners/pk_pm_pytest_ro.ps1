...
tar.exe -czf $tar -C $W trading_corp/prediction_markets trading_corp/data trading_corp/scripts/pm_cli.py tests/prediction_markets tests/conftest.py pyproject.toml trading_corp/__init__.py
