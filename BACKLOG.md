...
<!-- Polymarket P1/P2 closure records carried from main a6bb74c during the 2026-08-14 main<-prod-live reconcile merge. The polymarket_arbitrage division was CLOSED 2026-08-06 (no edge, premise refuted). prod-live BACKLOG (descended from the 2026-07-31 prod-truth reconcile 2fe3805) did not carry these entries; preserved here so no closure record is lost in the sync. -->
