...
class Secrets:
    ...
    # Kalshi MARC (third account, 2026-09-20). Isolated keypair, an exact
    # mirror of the karen fields above; resolved via secret_ref 'kalshi_marc'
    # in shard_snapshot_task._SECRET_REF_KEYPAIR. KALSHI_MARC_* env /
